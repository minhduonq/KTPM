    ...
    return (
        <div className='p-5' style={{ overflowY: 'auto', maxHeight: '98vh' }}>
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <button title='button' onClick={fetchContainerStatus} className="p-2 bg-gray-200 rounded-full hover:bg-gray-300">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <button title='button' onClick={fetchUsageData} className="p-2 bg-gray-200 rounded-full hover:bg-gray-300">
                    <ArrowPathIcon className="h-5 w-5 text-gray-700" />
                </button>
            </div>
